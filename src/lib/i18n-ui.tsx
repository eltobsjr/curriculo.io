...
const PT: Dict = {
  ...
  "editor.importLattes": "importar do Lattes",
  "editor.clear": "limpar",
  ...
  "section.publicacoes.title": "Publicações (opcional)",
  "section.publicacoes.help": "Artigos, livros, capítulos e trabalhos em eventos. Importados automaticamente do Lattes.",
  // quality checks
  ...
  // writing helper
  "helper.toggle": "✨ Ajuda para escrever",
  "helper.verbs": "Comece com um verbo de ação:",
  "helper.templates": "Ou use um modelo de frase:",
  // field labels
  "field.photo": "Foto (opcional)",
  "field.noPhoto": "sem foto",
  "field.uploadPhoto": "Enviar foto",
  "field.removePhoto": "remover",
  "field.fullName": "Nome completo",
  "field.headline": "Título / Cargo-alvo",
  "field.email": "E-mail",
  "field.phone": "Telefone",
  "field.location": "Localização",
  "field.website": "Site / Portfólio (opcional)",
  "field.socialLinks": "Links e redes (opcional)",
  "field.skillLevel": "Nível",
  // placeholders
  "ph.fullName": "Ana Martins",
  "ph.headline": "Desenvolvedora Front-end",
  "ph.email": "voce@email.com",
  "ph.phone": "(11) 90000-0000",
  "ph.location": "São Paulo, SP",
  "ph.website": "seusite.com",
  "ph.socialLabel": "LinkedIn",
  "ph.socialUrl": "linkedin.com/in/voce",
  "ph.summary": "Ex.: Desenvolvedora front-end com 7 anos de experiência criando interfaces acessíveis com React. Busco liderar projetos de produto com foco em qualidade.",
  "ph.role": "Cargo",
  "ph.company": "Empresa",
  "ph.city": "Local",
  "ph.startDate": "Início",
  "ph.endDate": "Fim / Atual",
  "ph.endDateEdu": "Fim",
  "ph.expDesc": "Uma conquista por linha. Ex.: Aumentou a conversão mobile em 18%.",
  "ph.degree": "Curso / Grau",
  "ph.institution": "Instituição",
  "ph.skillName": "React",
  "ph.langName": "Inglês",
  "ph.langLevel": "Fluente",
  "ph.projectName": "Nome do projeto",
  "ph.projectUrl": "link",
  "ph.projectDesc": "Breve descrição",
  "ph.certName": "Certificação",
  "ph.certIssuer": "Emissor",
  "ph.certYear": "Ano",
  "ph.pubTitle": "Título do trabalho",
  "ph.pubVenue": "Periódico / evento / editora",
  "ph.pubYear": "Ano",
  "ph.pubUrl": "DOI / link",
  // list labels
  "list.addLink": "Adicionar link",
  "list.link": "Link",
  "list.addExp": "Adicionar experiência",
  "list.newExp": "Nova experiência",
  "list.addEdu": "Adicionar formação",
  "list.newEdu": "Nova formação",
  "list.addSkill": "Adicionar competência",
  "list.skill": "Competência",
  "list.addLang": "Adicionar idioma",
  "list.lang": "Idioma",
  "list.addProject": "Adicionar projeto",
  "list.project": "Projeto",
  "list.addCert": "Adicionar certificação",
  "list.cert": "Certificação",
  "list.addPub": "Adicionar publicação",
  "list.pub": "Publicação",
  "list.moveUp": "Mover para cima",
  "list.moveDown": "Mover para baixo",
  "list.remove": "Remover",
  // misc
  "common.close": "Fechar",
};
...
const EN: Dict = {
  ...
  "editor.importLattes": "import from Lattes",
  "editor.clear": "clear",
  ...
  "section.publicacoes.title": "Publications (optional)",
  "section.publicacoes.help": "Articles, books, chapters and conference papers. Imported automatically from Lattes.",
  ...
  "preview.page": "Page {n}",
  "helper.toggle": "✨ Writing help",
  "helper.verbs": "Start with an action verb:",
  "helper.templates": "Or use a sentence template:",
  "field.photo": "Photo (optional)",
  "field.noPhoto": "no photo",
  "field.uploadPhoto": "Upload photo",
  "field.removePhoto": "remove",
  "field.fullName": "Full name",
  "field.headline": "Title / Target role",
  "field.email": "Email",
  "field.phone": "Phone",
  "field.location": "Location",
  "field.website": "Website / Portfolio (optional)",
  "field.socialLinks": "Links & networks (optional)",
  "field.skillLevel": "Level",
  "ph.fullName": "John Smith",
  "ph.headline": "Front-end Developer",
  "ph.email": "you@email.com",
  "ph.phone": "+1 (555) 000-0000",
  "ph.location": "New York, NY",
  "ph.website": "yoursite.com",
  "ph.socialLabel": "LinkedIn",
  "ph.socialUrl": "linkedin.com/in/you",
  "ph.summary": "Ex.: Front-end developer with 7 years of experience building accessible interfaces with React. Looking to lead product projects focused on quality.",
  "ph.role": "Position",
  "ph.company": "Company",
  "ph.city": "City",
  "ph.startDate": "Start",
  "ph.endDate": "End / Present",
  "ph.endDateEdu": "End",
  "ph.expDesc": "One achievement per line. Ex.: Increased mobile conversion by 18%.",
  "ph.degree": "Course / Degree",
  "ph.institution": "Institution",
  "ph.skillName": "React",
  "ph.langName": "English",
  "ph.langLevel": "Fluent",
  "ph.projectName": "Project name",
  "ph.projectUrl": "link",
  "ph.projectDesc": "Brief description",
  "ph.certName": "Certification",
  "ph.certIssuer": "Issuer",
  "ph.certYear": "Year",
  "ph.pubTitle": "Work title",
  "ph.pubVenue": "Journal / event / publisher",
  "ph.pubYear": "Year",
  "ph.pubUrl": "DOI / link",
  "list.addLink": "Add link",
  "list.link": "Link",
  "list.addExp": "Add experience",
  "list.newExp": "New experience",
  "list.addEdu": "Add education",
  "list.newEdu": "New education",
  "list.addSkill": "Add skill",
  "list.skill": "Skill",
  "list.addLang": "Add language",
  "list.lang": "Language",
  "list.addProject": "Add project",
  "list.project": "Project",
  "list.addCert": "Add certification",
  "list.cert": "Certification",
  "list.addPub": "Add publication",
...
const ES: Dict = {
  ...
  "editor.export": "exportar",
  "editor.import": "importar",
  "editor.importLattes": "importar de Lattes",
  ...
  "section.publicacoes.title": "Publicaciones (opcional)",
  "section.publicacoes.help": "Artículos, libros, capítulos y trabajos en eventos. Importados automáticamente de Lattes.",
  ...
  "preview.page": "Página {n}",
  "helper.toggle": "✨ Ayuda para escribir",
  "helper.verbs": "Empieza con un verbo de acción:",
  "helper.templates": "O usa una frase modelo:",
  "field.photo": "Foto (opcional)",
  "field.noPhoto": "sin foto",
  "field.uploadPhoto": "Subir foto",
  "field.removePhoto": "eliminar",
  "field.fullName": "Nombre completo",
  "field.headline": "Título / Puesto objetivo",
  "field.email": "Correo electrónico",
  "field.phone": "Teléfono",
  "field.location": "Ubicación",
  "field.website": "Sitio / Portafolio (opcional)",
  "field.socialLinks": "Redes y enlaces (opcional)",
  "field.skillLevel": "Nivel",
  "ph.fullName": "Ana García",
  "ph.headline": "Desarrolladora Front-end",
  "ph.email": "tu@email.com",
  "ph.phone": "+34 600 000 000",
  "ph.location": "Madrid, España",
  "ph.website": "tusitio.com",
  "ph.socialLabel": "LinkedIn",
  "ph.socialUrl": "linkedin.com/in/tu",
  "ph.summary": "Ej.: Desarrolladora front-end con 7 años de experiencia creando interfaces accesibles con React. Busco liderar proyectos de producto con foco en calidad.",
  "ph.role": "Cargo",
  "ph.company": "Empresa",
  "ph.city": "Ciudad",
  "ph.startDate": "Inicio",
  "ph.endDate": "Fin / Actual",
  "ph.endDateEdu": "Fin",
  "ph.expDesc": "Un logro por línea. Ej.: Aumentó la conversión móvil un 18%.",
  "ph.degree": "Curso / Grado",
  "ph.institution": "Institución",
  "ph.skillName": "React",
  "ph.langName": "Inglés",
  "ph.langLevel": "Fluido",
  "ph.projectName": "Nombre del proyecto",
  "ph.projectUrl": "enlace",
  "ph.projectDesc": "Breve descripción",
  "ph.certName": "Certificación",
  "ph.certIssuer": "Emisor",
  "ph.certYear": "Año",
  "ph.pubTitle": "Título del trabajo",
  "ph.pubVenue": "Revista / evento / editorial",
  "ph.pubYear": "Año",
  "ph.pubUrl": "DOI / enlace",
  "list.addLink": "Agregar enlace",
  "list.link": "Enlace",
  "list.addExp": "Agregar experiencia",
  "list.newExp": "Nueva experiencia",
  "list.addEdu": "Agregar formación",
  "list.newEdu": "Nueva formación",
  "list.addSkill": "Agregar competencia",
  "list.skill": "Competencia",
  "list.addLang": "Agregar idioma",
  "list.lang": "Idioma",
  "list.addProject": "Agregar proyecto",
  "list.project": "Proyecto",
  "list.addCert": "Agregar certificación",
  "list.cert": "Certificación",
  "list.addPub": "Agregar publicación",
  "list.pub": "Publicación",
  "list.moveUp": "Subir",
  "list.moveDown": "Bajar",
